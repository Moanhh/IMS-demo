...
public class SalesPage extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        sellButton.setFont(new java.awt.Font("Arial Rounded MT Bold", 1, 12)); // NOI18N
        ...
        addCustButton.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 13)); // NOI18N
        ...
        if (custCodeText.getText().equals("") || prodCodeText.getText().equals("")
            ...
            try {
                ...
                if (resultSet.next()) {
                    ...
                    Double sellPrice = Double.valueOf(priceText.getText());
                    Double totalRevenue = sellPrice * Integer.valueOf(quantityText.getText());

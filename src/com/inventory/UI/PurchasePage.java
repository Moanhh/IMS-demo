...
public class PurchasePage extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        refreshButton.setFont(new java.awt.Font("Arial Unicode MS", 1, 12)); // NOI18N
        ...
        if (codeText.getText().equals("") || jDateChooser1.getDate()==null
            ...
            try {
                ...
                if (resultSet.next()) {
                    ...
                    Double costPrice = Double.valueOf(costText.getText());
                    Double totalCost = costPrice * Integer.valueOf(quantityText.getText());
